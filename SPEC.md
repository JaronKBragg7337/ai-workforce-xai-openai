...
**The spark.** The condition that starts each cycle’s real work is not hardcoded — it is a live check (what changed, what is worth pursuing, what the operator is focused on), anchored to a real source such as the operator’s public X activity or public repositories.
